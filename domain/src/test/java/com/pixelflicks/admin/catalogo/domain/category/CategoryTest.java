...
public class CategoryTest {
    ...
    public void givenAValidCategory_whenCallUpdate_thenReturnCategoryUpdate(){
        ...
        final var aCategory =
                Category.newCategory("Film", "A categoria menos assistida", expectedIsActive);
    ...
    public void givenAValidCategory_whenCallUpdateToInactive_thenReturnCategoryUpdate(){
        ...
        final var aCategory =
                Category.newCategory("Film", "A categoria menos assistida", true);
    ...
    @Test
    public void givenAInvalidCategory_whenCallUpdateWithInvalidParam_thenReturnCategoryUpdate(){
        final String expectedName = null;
        final var expectedDescription = "A categoria mais assistida";
        final var expectedIsActive = true;

        final var aCategory =
                Category.newCategory("Filmes", "A categoria menos assistida", expectedIsActive);
